        ...
        <div class="top-head">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <ul class="nav-head1">
                            <li style="padding-top: 8px;"><a href=""><i class="fa fa-envelope"></i> customer@support.com</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
                        <ul class="nav-head2">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 clearfix">
                        <a href="<?php echo e(url('/')); ?>"><img class="logo" src="<?php echo e(URL::asset('image/logo.jpg')); ?>" alt="Company logo"></a>
                    </div>
                    <div class="col-12 col-md-8 middle">
                        <ul class="navbar-links">
                            ...
                            <li><a href="<?php echo e(url('/home')); ?>"><i class="fa fa-user"></i> Account</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="single-widget">
                            <h2>Quick Shop</h2>
                            <ul class="nav nav-pills " style="display: grid;">
                    ...
                    <div class="col-sm-3 offset-sm-1">
                        <div class="single-widget">
                            ...
                            <form action="#" class="searchform">
                                ...
                                <button type="submit" class="btn btn-outline-primary"><i class="fas fa-arrow-circle-right"></i></button>
                ...
                <div class="container copyright">
                    ...
                    <p class="pull-right">Source Code <span><a target="_blank" href="https://github.com/singhgaurav2323/ecommerce"><i class="fab fa-github"></i></a></span></p>
                </div>
            </div>
        </footer>
...
</html><?php /**PATH D:\e-commerce\backend\ecom\resources\views/welcome.blade.php ENDPATH**/ ?>